...
import           PokerLogic         (Combination, Hand (..), evaluateHand,
                                     mkHand, updateHand)
import           Utilities          (hasDuplicates, incrementMod, repeatM)
...
-- | Given a @PokerPlayerAction@ and a @PokerGame@, if the game is in a valid state
-- and the action is valid, returns a new game with updated state
